...
| --- | --- | --- | --- |
| [Jakub Krehel's skills](https://github.com/jakubkrehel/skills), [jakub.kr](https://jakub.kr/skills), and [interfaces.dev](https://interfaces.dev/) | Public repository marked MIT when reviewed | Interface hierarchy, typography, color, layout, writing, accessibility, polish, gestures, shared layout, and gradients | Principles were re-expressed and reorganized; no article or skill is mirrored verbatim |
| [Emil Kowalski's skills](https://github.com/emilkowalski/skills), [emilkowal.ski](https://emilkowal.ski/skill), and [animations.dev](https://animations.dev/) | Public repository marked MIT when reviewed | Motion purpose, frequency, easing, interruption, review vocabulary, reduced motion, and implementation tradeoffs | Only public material reviewed; paid course skills and content are excluded |
